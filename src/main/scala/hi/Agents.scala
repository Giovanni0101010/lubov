...
object Agents {
 ...
 val agentList = List("""Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/532.1 (KHTML, like Gecko) Chrome/4.0.219.6 Safari/532.1""",
   ...
   val agentList2 = List("""Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; WOW64; Trident/4.0; SLCC1)""",
   """Mozilla/1.22 (compatible; Konqueror/4.3; Linux) KHTML/4.3.5 (like Gecko)""",
   """Mozilla/4.0 (compatible; MSIE 6.0; Windows CE; IEMobile 6.5)""",
   """Opera/9.80 (Macintosh; U; de-de) Presto/2.8.131 Version/11.10""",
   """Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.1.9) Gecko/20100318 Mandriva/2.0.4-69.1mib2010.0 SeaMonkey/2.0.4""",
  ...
  def getCustomClientAgent: String = {
    agentList(random.nextInt(agentList.length))
  }
}
